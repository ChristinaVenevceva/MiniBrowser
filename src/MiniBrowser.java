  ...
  implements HyperlinkListener
{
  ...
  // as replacement for function JEditorPane.getPage()
  private URL getCurrentUrl() {
	  return _currentUrl;
  }
  private URL setCurrentUrl(URL pageUrl) {
	  _currentUrl = pageUrl;
  ...
  private void actionBack() {
    URL currentUrl = getCurrentUrl(); //displayEditorPane.getPage();
  ...
  private void showPage(URL pageUrl, boolean addToList)
  {
    ...
    try {
      ...
      URL newUrl = setCurrentUrl(pageUrl); //displayEditorPane.getPage();
  ...
  public static void main(String[] args) {
    ...
    browser.setVisible(true); //browser.show();
  }
}
